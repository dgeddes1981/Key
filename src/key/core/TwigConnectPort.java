...
**          ####  \###L ##########   #####"
**
**  $Id: TwigConnectPort.java,v 1.2 1999/11/23 21:37:13 pdm Exp $
**
**  Class History
**
...
public class TwigConnectPort extends Daemon
{
	private static final long serialVersionUID = -9053728784766596365L;
	
	public static final AtomicElement[] ELEMENTS =
	{
		AtomicElement.construct( TwigConnectPort.class, Integer.TYPE, "port",
	...
	public TwigConnectPort()
	{
	}
	
	public TwigConnectPort( int portNumber )
	{
		port = portNumber;
	}
	
	public TwigConnectPort( Object key, int portNumber )
	{
		port = portNumber;
		setKey( key );
	}
